...
model=load_model(filepath=r"C:\Users\nanip\OneDrive\Minor Project 2\Imaged-Based-Crop-Disease-Detection-using-Transfer-Learning-and-MobileNetV2-main\mobilenet_model.h5")
data_dir = r"C:\Users\nanip\OneDrive\Desktop\New Plant Diseases Dataset(Augmented)\New Plant Diseases Dataset(Augmented)\train"
batch_size = 3
img_height = 224
img_width = 224
# Load dataset
